        ...
        <div className="bg-[#F9F9F9] py-10 mt-32 mb-32 lg:mb-64">
            ...
            <div className="flex flex-col lg:flex-row max-w-7xl mx-auto px-4 gap-6">
                ...
                <div data-aos="fade-up" className="lg:w-1/2 text-center lg:text-start py-8 lg:py-0">
                    ...
                    >
                        We value your connection. Reach out for inquiries, collaborations, or to share your thoughts. Your feedback is essential in our mission to make a positive impact through blood donation. Let&apos;s stay connected and continue saving lives together.
                    </Typography>
                    <div
                    ...
                    >
                        ...
                        <span className="text-lg text-gray-600 font-semibold cursor-pointer transition-all hover:text-gray-800">123-236-4536</span>
                    </div>
                    <div className="flex gap-4 text-blue-gray-900 justify-center lg:justify-start">
                        <Typography>
                ...
                <div data-aos="fade-down" className="w-full lg:w-1/2 lg:-mb-40">
                    <form className="p-6 lg:p-10 bg-gray-50 shadow-lg rounded-xl flex flex-col gap-6">
                        <Typography
                            color="gray"
                            className="mb-4 text-lg lg:text-3xl font-medium text-center"
                        >
                            Get in Touch
                        </Typography>
                        ...
                        <div className="">
                            <Button fullWidth color="red">Send</Button>
                        </div>
                    </form>
                </div>
            </div>
